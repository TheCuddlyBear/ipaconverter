...
export function AsyncIPAFromAlphabet(input: string, comboArray: Array<[string, string]>): Promise<string>{
...
export function AsyncIPAFromSyllabary(input: string, comboArray: Array<[string, string]>): Promise<string>{
  return new Promise((resolve, reject) => {
    var ipa: string = "";
    var stringArray: Array<string> = input.split("");
    stringArray.forEach((letter: string) => {
...
export function AsyncIPAFromAbugida(input: string, consonantArray: Array<[string, string]>, vowelArray: Array<[string, string]>, placeholder: string): Promise<string> {
  return new Promise((resolve, reject) => {
    var ipa: string = "";
    var comboArray: Array<[string, string]> = [];
    var regexStr: string = "(";
...
export default {
  IPAFromAlphabet,
  AsyncIPAFromAlphabet,
  IPAFromSyllabary,
  AsyncIPAFromSyllabary,
  IPAFromAbugida,
  AsyncIPAFromAbugida,
};
